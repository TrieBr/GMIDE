/********************************************************************************
** Form generated from reading UI file 'asseteditor_sprite.ui'
**
...
#ifndef UI_ASSETEDITOR_SPRITE_H
#define UI_ASSETEDITOR_SPRITE_H
...
public:
    ...
    QSplitter *splitter_previewAndFrames;
    QFrame *frame;
    ...
    void setupUi(QMainWindow *AssetEditor_Sprite)
    {
        if (AssetEditor_Sprite->objectName().isEmpty())
            AssetEditor_Sprite->setObjectName(QStringLiteral("AssetEditor_Sprite"));
        AssetEditor_Sprite->resize(800, 600);
        actionSave_Close = new QAction(AssetEditor_Sprite);
        ...
        centralwidget = new QWidget(AssetEditor_Sprite);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 456, 551));
        ...
        sizePolicy2.setHeightForWidth(label_bboxType->sizePolicy().hasHeightForWidth());
        label_bboxType->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(label_bboxShape->sizePolicy().hasHeightForWidth());
        label_bboxShape->setSizePolicy(sizePolicy2);
        ...
        splitter_previewAndFrames = new QSplitter(widget);
        splitter_previewAndFrames->setObjectName(QStringLiteral("splitter_previewAndFrames"));
        splitter_previewAndFrames->setOrientation(Qt::Vertical);
        frame = new QFrame(splitter_previewAndFrames);
        ...
        toolButton_zoomFit->setCheckable(true);
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/main/icons/checkerboard.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        graphicsView_spritePreview = new QGraphicsView(frame);
        ...
        splitter_previewAndFrames->addWidget(frame);
        spriteFrameView = new WidgetSpriteFrameView(splitter_previewAndFrames);
        spriteFrameView->setObjectName(QStringLiteral("spriteFrameView"));
        QSizePolicy sizePolicy5(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy5.setHorizontalStretch(0);
        sizePolicy5.setVerticalStretch(0);
        sizePolicy5.setHeightForWidth(spriteFrameView->sizePolicy().hasHeightForWidth());
        spriteFrameView->setSizePolicy(sizePolicy5);
        spriteFrameView->setFrameShape(QFrame::StyledPanel);
        spriteFrameView->setFrameShadow(QFrame::Raised);
        splitter_previewAndFrames->addWidget(spriteFrameView);

        gridLayout->addWidget(splitter_previewAndFrames, 0, 0, 1, 1);

        splitter->addWidget(widget);

        gridLayout_9->addWidget(splitter, 0, 0, 1, 1);

        AssetEditor_Sprite->setCentralWidget(centralwidget);
        toolBar = new QToolBar(AssetEditor_Sprite);
        toolBar->setObjectName(QStringLiteral("toolBar"));
        AssetEditor_Sprite->addToolBar(Qt::TopToolBarArea, toolBar);

        toolBar->addAction(actionSave_Close);
        toolBar->addSeparator();

        retranslateUi(AssetEditor_Sprite);

        QMetaObject::connectSlotsByName(AssetEditor_Sprite);
    } // setupUi

    void retranslateUi(QMainWindow *AssetEditor_Sprite)
    {
        AssetEditor_Sprite->setWindowTitle(QApplication::translate("AssetEditor_Sprite", "MainWindow", 0));
        actionSave_Close->setText(QApplication::translate("AssetEditor_Sprite", "Save & Close", 0));
#ifndef QT_NO_TOOLTIP
        actionSave_Close->setToolTip(QApplication::translate("AssetEditor_Sprite", "Save and close Sprite", 0));
#endif // QT_NO_TOOLTIP
        groupBox_properties->setTitle(QApplication::translate("AssetEditor_Sprite", "Properties", 0));
        label_widthTitle->setText(QApplication::translate("AssetEditor_Sprite", "Width:", 0));
        label_widthValue->setText(QApplication::translate("AssetEditor_Sprite", "0", 0));
        label_heightLabel->setText(QApplication::translate("AssetEditor_Sprite", "Height:", 0));
        label_heightValue->setText(QApplication::translate("AssetEditor_Sprite", "0", 0));
        label_numSubimagesLabel->setText(QApplication::translate("AssetEditor_Sprite", "Number of subimages:", 0));
        label_numSubimagesValue->setText(QApplication::translate("AssetEditor_Sprite", "0", 0));
        label_OriginLabel->setText(QApplication::translate("AssetEditor_Sprite", "Origin:", 0));
        label_originX->setText(QApplication::translate("AssetEditor_Sprite", "X", 0));
        label_originY->setText(QApplication::translate("AssetEditor_Sprite", "Y", 0));
        pushButton_originCenter->setText(QApplication::translate("AssetEditor_Sprite", "Center", 0));
        groupBox_2->setTitle(QApplication::translate("AssetEditor_Sprite", "Collision Checking", 0));
        checkBox_preciseCollisionChecking->setText(QApplication::translate("AssetEditor_Sprite", "&Precise collision checking", 0));
#ifndef QT_NO_TOOLTIP
        checkBox_seperateCollisionMasks->setToolTip(QApplication::translate("AssetEditor_Sprite", "Seperate collision masks for subimages", 0));
#endif // QT_NO_TOOLTIP
        checkBox_seperateCollisionMasks->setText(QApplication::translate("AssetEditor_Sprite", "Seper&ate collision masks", 0));
        label_alphaTolerance->setText(QApplication::translate("AssetEditor_Sprite", "Alpha Tolerance:", 0));
        groupBox_boundingBox->setTitle(QApplication::translate("AssetEditor_Sprite", "Bounding Box", 0));
        label_bboxType->setText(QApplication::translate("AssetEditor_Sprite", "Type:", 0));
        label_bboxShape->setText(QApplication::translate("AssetEditor_Sprite", "Shape:", 0));
        label_bboxLeft->setText(QApplication::translate("AssetEditor_Sprite", "Left: ", 0));
        label_bboxRight->setText(QApplication::translate("AssetEditor_Sprite", "Right:", 0));
        label_bboxTop->setText(QApplication::translate("AssetEditor_Sprite", "Top:", 0));
        label_bboxBottom->setText(QApplication::translate("AssetEditor_Sprite", "Bottom:", 0));
        groupBox_textureSettings->setTitle(QApplication::translate("AssetEditor_Sprite", "Texture Settings", 0));
        checkBox_tileHorizontal->setText(QApplication::translate("AssetEditor_Sprite", "Tile: Horizontal", 0));
        checkBox_tileVertical->setText(QApplication::translate("AssetEditor_Sprite", "Tile: Vertical", 0));
        checkBox_usedFor3D->setText(QApplication::translate("AssetEditor_Sprite", "Used for 3D (Must be a power of 2)", 0));
        label_textureGroup->setText(QApplication::translate("AssetEditor_Sprite", "Texture Group:", 0));
#ifndef QT_NO_TOOLTIP
        toolButton_animationToggle->setToolTip(QApplication::translate("AssetEditor_Sprite", "Play/Pause animation", 0));
#endif // QT_NO_TOOLTIP
        toolButton_animationToggle->setText(QString());
#ifndef QT_NO_TOOLTIP
        toolButton_zoomFit->setToolTip(QApplication::translate("AssetEditor_Sprite", "Fit sprite to view", 0));
#endif // QT_NO_TOOLTIP
        toolButton_zoomFit->setText(QString());
#ifndef QT_NO_TOOLTIP
        toolButton_zoomOriginal->setToolTip(QApplication::translate("AssetEditor_Sprite", "Zoom to 100%", 0));
#endif // QT_NO_TOOLTIP
        toolButton_zoomOriginal->setText(QString());
#ifndef QT_NO_TOOLTIP
        toolButton_zoomOut->setToolTip(QApplication::translate("AssetEditor_Sprite", "Zoom out", 0));
#endif // QT_NO_TOOLTIP
        toolButton_zoomOut->setText(QString());
#ifndef QT_NO_TOOLTIP
        toolButton_zoomIn->setToolTip(QApplication::translate("AssetEditor_Sprite", "Zoom in", 0));
#endif // QT_NO_TOOLTIP
        toolButton_zoomIn->setText(QString());
#ifndef QT_NO_TOOLTIP
        toolButton->setToolTip(QApplication::translate("AssetEditor_Sprite", "Toggle transparency background", 0));
#endif // QT_NO_TOOLTIP
        toolButton->setText(QString());
        toolBar->setWindowTitle(QApplication::translate("AssetEditor_Sprite", "toolBar", 0));
    } // retranslateUi

};

namespace Ui {
    class AssetEditor_Sprite: public Ui_AssetEditor_Sprite {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ASSETEDITOR_SPRITE_H
